...
static const cpu_instr_desc_t cpu_instr_descs[256] = {
    ...
    [CPU_OP_MOV_RR]   = {CPU_OP_MOV_RR,   2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_STR_RV0]  = {CPU_OP_STR_RV0,  2, {CPU_OPD_IMM32, CPU_OPD_REG}},
    [CPU_OP_STR_RI0]  = {CPU_OP_STR_RI0,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_STR_RI8]  = {CPU_OP_STR_RI8,  3, {CPU_OPD_REG, CPU_OPD_IMM8, CPU_OPD_REG}},
    [CPU_OP_STR_RI32] = {CPU_OP_STR_RI32, 3, {CPU_OPD_REG, CPU_OPD_IMM32, CPU_OPD_REG}},
    [CPU_OP_STR_RIR]  = {CPU_OP_STR_RIR,  3, {CPU_OPD_REG, CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_LDR_RV0]  = {CPU_OP_LDR_RV0,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_LDR_RI0]  = {CPU_OP_LDR_RI0,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_LDR_RI8]  = {CPU_OP_LDR_RI8,  3, {CPU_OPD_REG, CPU_OPD_REG, CPU_OPD_IMM8}},
    [CPU_OP_LDR_RI32] = {CPU_OP_LDR_RI32, 3, {CPU_OPD_REG, CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_LDR_RIR]  = {CPU_OP_LDR_RIR,  3, {CPU_OPD_REG, CPU_OPD_REG, CPU_OPD_REG}},

    [CPU_OP_ADD_RR]  = {CPU_OP_ADD_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_ADD_RV]  = {CPU_OP_ADD_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_SUB_RR]  = {CPU_OP_SUB_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_SUB_RV]  = {CPU_OP_SUB_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_MUL_RR]  = {CPU_OP_MUL_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_MUL_RV]  = {CPU_OP_MUL_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_DIV_RR]  = {CPU_OP_DIV_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_DIV_RV]  = {CPU_OP_DIV_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_IDIV_RR] = {CPU_OP_IDIV_RR, 2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_IDIV_RV] = {CPU_OP_IDIV_RV, 2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_AND_RR]  = {CPU_OP_AND_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_AND_RV]  = {CPU_OP_AND_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_OR_RR]   = {CPU_OP_OR_RR,   2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_OR_RV]   = {CPU_OP_OR_RV,   2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_XOR_RR]  = {CPU_OP_XOR_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_XOR_RV]  = {CPU_OP_XOR_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM32}},
    [CPU_OP_NOT_R]   = {CPU_OP_NOT_R,   1, {CPU_OPD_REG}},
    [CPU_OP_SHL_RR]  = {CPU_OP_SHL_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_SHL_RV]  = {CPU_OP_SHL_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM5}},
    [CPU_OP_SHR_RR]  = {CPU_OP_SHR_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_SHR_RV]  = {CPU_OP_SHR_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM5}},
    [CPU_OP_ROR_RR]  = {CPU_OP_ROR_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_ROR_RV]  = {CPU_OP_ROR_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM5}},
    [CPU_OP_ROL_RR]  = {CPU_OP_ROL_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_ROL_RV]  = {CPU_OP_ROL_RV,  2, {CPU_OPD_REG, CPU_OPD_IMM5}},
    [CPU_OP_CMP_RR]  = {CPU_OP_CMP_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
    [CPU_OP_TST_RR]  = {CPU_OP_TST_RR,  2, {CPU_OPD_REG, CPU_OPD_REG}},
